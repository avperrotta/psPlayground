...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 375.0, 195.0, 57.0, 20.0 ],
									"text" : "dac~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 120.0, 105.0, 42.0, 20.0 ],
									"text" : "*~ 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 261.0, 150.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 210.0, 150.0, 38.0, 19.0 ],
									"text" : "open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 210.0, 180.0, 71.0, 20.0 ],
									"text" : "sfrecord~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 240.0, 75.0, 158.0, 20.0 ],
									"text" : "receive~ ph-01.preDac.2.ch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 75.0, 75.0, 158.0, 20.0 ],
									"text" : "receive~ ph-01.preDac.1.ch"
								}
...
,
					"patching_rect" : [ 1230.0, 165.0, 62.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1260.0, 255.0, 123.0, 18.0 ],
					"text" : "sendAudioTo preDac"
				}
...
, 						{
							"number" : 8,
							"data" : [ 12, "obj-3", "multislider", "list", 60, 60, 60, 60, 60, 60, 60, 60 ]
						}
 ]
				}
...
, 						{
							"number" : 7,
							"data" : [ 5, "obj-49", "flonum", "float", 30.0, 5, "obj-54", "flonum", "float", 30.222221, 5, "obj-9", "toggle", "int", 1, 5, "obj-16", "number", "int", 1, 5, "obj-24", "number", "int", 1, 5, "obj-28", "number", "int", 246, 5, "obj-35", "flonum", "float", 0.46, 5, "obj-40", "flonum", "float", -1.36, 5, "obj-42", "flonum", "float", 0.0, 5, "obj-45", "flonum", "float", -0.7, 5, "obj-60", "number", "int", 88, 5, "obj-62", "number", "int", 340, 5, "obj-66", "flonum", "float", 0.001, 5, "obj-25", "flonum", "float", 0.05, 5, "obj-69", "flonum", "float", 0.45, 5, "obj-67", "flonum", "float", 0.0, 5, "obj-73", "flonum", "float", 1.57, 5, "obj-63", "flonum", "float", 1.57, 5, "obj-112", "toggle", "int", 1, 5, "obj-109", "number", "int", 1, 5, "obj-106", "number", "int", 1, 5, "obj-104", "number", "int", 100, 5, "obj-102", "flonum", "float", 0.54, 5, "obj-99", "flonum", "float", 0.73, 5, "obj-98", "flonum", "float", 0.0, 5, "obj-97", "flonum", "float", -0.8, 5, "obj-91", "number", "int", 29, 5, "obj-90", "number", "int", 50, 5, "obj-87", "flonum", "float", 0.001, 5, "obj-86", "flonum", "float", 0.05, 5, "obj-83", "flonum", "float", 2.85, 5, "obj-82", "flonum", "float", 3.3, 5, "obj-79", "flonum", "float", 1.57, 5, "obj-77", "flonum", "float", 1.57, 12, "obj-3", "multislider", "list", 79, 36, 48, 60, 72, 46, 39, 70, 5, "obj-41", "toggle", "int", 1, 5, "obj-59", "toggle", "int", 1, 5, "obj-43", "toggle", "int", 0, 5, "obj-50", "toggle", "int", 0, 5, "obj-78", "flonum", "float", 0.46, 5, "obj-29", "flonum", "float", 8.0 ]
						}
 ]
				}
